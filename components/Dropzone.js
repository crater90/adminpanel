...
function Dropzone({ values, setValues }) {
    ...
    <div className='flex space-x-4 p-3'>
        <button className='p-3 bg-gray-700 text-white rounded-lg' onClick={(e)=> setValues({...values, image:images })}>Upload to Form</button>
    </div>
    </>
    )
}
